...
def parse_args():
    ...
    parser.add_argument("--epoch", help="Path to custom detections.", type=int, default=10000)
    ...
    parser.add_argument("--interval", help='Save checkpoint interval.', type=int, default=1000)
    ...
    parser.add_argument("--decay_epoch", help="decay epochs.", type=int, default=10)
    parser.add_argument('--gamma', type=float, default=0.80, help='learning rate decay.')
...
model.train(args.epoch, data, callbacks=callbacks)
if args.run_modelarts:
